...
# Salva o resultado do passo 1 em um arquivo
with open("test/saidas.txt", "w") as f:
    f.write(f"Caso 1: \"Ola mundo!\"\n\nPasso 1:\n{str(saida_passo_1)}\n\n")
...
# Salva o resultado do passo 2 no mesmo arquivo
with open("test/saidas.txt", "a") as f:
    f.write(f"Passo 2:\n{str(saida_passo_2)}\n\n")
...
# Salva o resultado do passo 3 no mesmo arquivo
with open("test/saidas.txt", "a") as f:
    f.write(f"Passo 3:\n{str(saida_passo_3)}\n\n")
    f.write(f"Passo 4:\n{str(saida_passo_3[:16])}\n\n")
...
# Salva o resultado do passo 4 (hex) no mesmo arquivo
with open("test/saidas.txt", "a") as f:
    f.write(f"Hex:\n{saida}\n\n")
